...
const CATEGORY_MAP = {
  'vedas/samhita': { category: 'Vedas', subcategory: 'Samhita' },
  'vedas/brahmana': { category: 'Vedas', subcategory: 'Brahmana' },
  'vedas/aranyaka': { category: 'Vedas', subcategory: 'Aranyaka' },
  'vedas/upanishad': { category: 'Vedas', subcategory: 'Upanishad' },
  'vedas': { category: 'Vedas', subcategory: 'General' },
  'smriti': { category: 'Smriti', subcategory: 'Itihasa & Purana' },
  'shlokas': { category: 'Shlokas', subcategory: 'Stotras' },
}
...
function getCategory(filePath) {
  ...
  for (const [pattern, cat] of Object.entries(CATEGORY_MAP)) {
    if (dir.startsWith(pattern) || dir === pattern) {
      return cat
    }
  }
